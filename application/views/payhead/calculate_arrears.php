    <div class="main-panel">
        ...
        <!-- Left side -->
        <div class="col-md-6">
            <h3 class="mb-0">Calculate Arrear</h3>
        </div>
        <!-- Right side -->
       <div class="col-md-6 text-md-right text-start">
                    <a href="<?php echo base_url('index.php/salary/arrear_list'); ?>" 
    ...
    <?php endif; ?>
          ...
          <?php endif; ?>
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                        <form method="POST" id="form" action="<?php echo base_url();?>index.php/salary/calculate_arrears" >
